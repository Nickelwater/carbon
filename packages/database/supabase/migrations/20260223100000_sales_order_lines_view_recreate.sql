-- Recreate salesOrderLines view so it includes the lineNumber column added to salesOrderLine.
-- In PostgreSQL, view columns are fixed at definition time; sl.* did not pick up lineNumber.
