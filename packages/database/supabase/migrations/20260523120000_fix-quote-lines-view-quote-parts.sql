-- Restore quoteLines support for quote-only parts (quotePartId, no itemId).
-- 20260513120000_line-item-sort-order.sql recreated quoteLines with INNER JOIN "item",
-- which excluded those rows and broke loaders that use .single() on quoteLines.
