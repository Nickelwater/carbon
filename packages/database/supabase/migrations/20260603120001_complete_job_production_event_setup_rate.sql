-- Patch complete_job_to_inventory production event rates
...
BEGIN
  ...
  FOR v_event IN
    SELECT
      ...
      pe.type,
      pe."employeeId",
      wc."laborRate", wc."machineRate", wc."setupRate"
  ...
  LOOP
    ...
    v_rate := production_event_hourly_rate(v_event.type, v_event."setupRate", v_event."laborRate", v_event."machineRate");
