-- Restore parts.customerPartSummary for search and display.
-- 20260419130000_fix-item-views-filter-by-type.sql recreated "parts" with the type
-- filter fix but dropped the customerPartSummary column from 20260330120000.
-- Must DROP first: CREATE OR REPLACE cannot insert a column before unitOfMeasure (42P16).
