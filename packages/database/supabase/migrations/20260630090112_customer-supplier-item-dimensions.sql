...
ALTER TYPE "dimensionEntityType" ADD VALUE IF NOT EXISTS 'Customer';
ALTER TYPE "dimensionEntityType" ADD VALUE IF NOT EXISTS 'Supplier';
ALTER TYPE "dimensionEntityType" ADD VALUE IF NOT EXISTS 'Item';
