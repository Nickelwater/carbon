...
- Associations (10 types, see `nonConformanceAssociationType`):
  ...
  created `20260421091238` as `nonConformanceInboundInspection`, renamed
  `20260722132135` — see `.ai/rules/inbound-inspection-system.md`). The
  association-type key is `"inspections"` in the UI/validators.
